...
function handleLogs(client) {
    ...
    client.on("guildMemberAdd", (member) => {
        ...
        return send_log(member.guild.id, j);
    ...
    client.on("guildMemberRemove", (member) => {
        ...
        return send_log(member.guild.id, l);
    ...
    client.on("guildVanityURLUpdate", (guild, oldVanityURL, newVanityURL) => {
        ...
        return send_log(guild.id, van);

    })

    // Message Pinned
    client.on("channelPinsUpdate", function (message, channel) {

        const embed2 = new EmbedBuilder()
            .setTitle(`Message Was Pinned Or Unpinned In ${channel}`)
            .setColor('Red')

        return send_log(message.guild.id, embed2);
    });
    ...
    .setColor('Grey')
    .setDescription(`Message Edited from \`${message}\` to \`${newContent}\` by ${message.author}`);

if (!message.author.bot) return send_log(message.guild.id, embed);
    ...
    client.on("voiceChannelJoin", (member, channel) => {
        ...
        const jv = new EmbedBuilder()
            .setTitle('Voice Channel Joined')
            .setColor('Green')
            .setDescription(member.user.tag + " joined " + `${channel}` + "!");

        return send_log(member.guild.id, jv);
    ...
    client.on("voiceChannelLeave", (member, channel) => {
        ...
        return send_log(member.guild.id, lb);
    ...
    client.on("voiceChannelSwitch", (member, oldChannel, newChannel) => {
        ...
        return send_log(member.guild.id, sw);
    ...
    client.on("voiceChannelMute", (member, muteType) => {
        ...
        const mt = new EmbedBuilder()
            .setTitle('User Muted')
            .setColor('Red')
            .setDescription(member.user.tag + " became muted! (type: " + muteType + ")");

        return send_log(member.guild.id, mt);
    ...
    client.on("voiceChannelUnmute", (member, oldMuteType) => {
        ...
        const unmt = new EmbedBuilder()
            .setTitle('User Unmuted')
            .setColor('Green')
            .setDescription(member.user.tag + " became unmuted!");

        return send_log(member.guild.id, unmt);
