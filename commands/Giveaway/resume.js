...
module.exports = {
    ...
    async execute(interaction, client) {
        ...
        if (!giveaway.pauseOptions.isPaused) {
            return interaction.reply({
                content: `https://discord.com/channels/${giveaway.guildId}/${giveaway.channelId}/${giveaway.messageId} is not paused!`,
                ephemeral: true
            });
        }
        ...
        client.giveawaysManager.unpause(giveaway.messageId)
            ...
            .then(() => {
                // Success message
                interaction.reply(`https://discord.com/channels/${giveaway.guildId}/${giveaway.channelId}/${giveaway.messageId} has been successfully resumed!`);
            })
            .catch((e) => {
                interaction.reply({
                    content: e,
